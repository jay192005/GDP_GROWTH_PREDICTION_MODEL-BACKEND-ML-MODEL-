...
def load_model_and_data():
    ...
    try:
        ...
        encoder = joblib.load("country_encoder_scenario.pkl")
        feature_info = joblib.load("feature_info_scenario.pkl")
        print(f"✅ Scenario Model loaded")
...
def home():
    """API information"""
    return jsonify({
        'name': 'GDP Economic Scenario Simulator',
